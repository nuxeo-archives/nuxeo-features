...
public interface Provider {
     ...
     * @return
     */
    List<Widget> addWidget(Widget widget, String regionName, int order)
            throws ProviderException;
     ...
     * @return
     */
    List<Widget> moveWidget(Widget widget, String destRegionName, int order)
            throws ProviderException;
     ...
     * @return
     */
    List<Widget> reorderWidget(Widget widget, int order) throws ProviderException;
     ...
     */
    List<Widget> removeWidget(Widget widget) throws ProviderException;
