...
public class TestJbpmEngine extends AbstractJbmTestCase {
    ...
    public void testPaginatedTasksAPI() throws WMWorkflowException {
        ...
        assertEquals(processesNumber, rSlice.getTotalResult());
        assertEquals(processesNumber, rSlice.getSlice().size());
        ...
        assertEquals(processesNumber, rSlice.getTotalResult());
        assertEquals(10, rSlice.getSlice().size());
        ...
        assertEquals(processesNumber, rSlice.getTotalResult());
        assertEquals(29, rSlice.getSlice().size());
        ...
        assertEquals(processesNumber, rSlice.getTotalResult());
        assertEquals(2, rSlice.getSlice().size());
