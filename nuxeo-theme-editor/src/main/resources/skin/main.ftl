...
<ul class="nxthemesSelector">
  ...
  <li <#if screen="preset-manager">class="selected"</#if><a href="javascript:NXThemesEditor.setThemeOptions()">Theme options</a></li>
  <li <#if screen="style-manager">class="selected"</#if><a href="javascript:NXThemesEditor.editCss()">CSS</a></li>
