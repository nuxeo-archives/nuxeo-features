...
import org.nuxeo.ecm.core.search.api.client.search.results.impl.CoreResultItem;
...
public class SearchPageProvider implements PagedDocumentsProvider {
    ...
    private DocumentModel constructDocumentModel(ResultItem rItem)
        ...
        if ( rItem instanceof CoreResultItem ){
            DocumentModel doc = ((CoreResultItem)rItem).getDocumentModel();
            if ( doc != null) {
                return doc;
            }
        }
